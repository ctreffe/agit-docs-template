...
3. After the maintainer answers, apply safe repository and documentation
   defaults to nonessential undecided details and update the project-specific context,
