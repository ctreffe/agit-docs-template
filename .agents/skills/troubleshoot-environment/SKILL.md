...
description: Diagnose and recover from recurring or clear setup, policy, permission and documentation-toolchain failures after the resident repository trigger pauses ordinary work. Do not use for expected content or render-review findings without infrastructure evidence.
---
